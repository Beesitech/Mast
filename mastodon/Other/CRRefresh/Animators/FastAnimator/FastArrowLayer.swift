...
class FastArrowLayer: CALayer,
    ...
    private func initLineLayer() {
        ...
        lineLayer?.strokeColor = UIColor.init(red: 145/255, green: 145/255, blue: 160/255, alpha: 1).cgColor
    ...
    private func initArrowLayer() {
        ...
        arrowLayer?.strokeColor = UIColor.init(red: 145/255, green: 145/255, blue: 160/255, alpha: 1).cgColor
