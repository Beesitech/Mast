...
class FastCircleLayer: CALayer {
    ...
    init(frame: CGRect,
         color: UIColor = .init(rgb: (104, 104, 114)),
         pointColor: UIColor = .init(rgb: (145, 145, 155)),
         lineWidth: CGFloat = 0) {
        self.color      = color
    ...
    private func drawCircle() {
        ...
        path.addArc(withCenter: .init(x: width/2,
                    ...
                    clockwise: false)
        circle.lineWidth   = 0
        circle.strokeColor = UIColor.init(red: 165/255, green: 165/255, blue: 180/255, alpha: 1).cgColor
    ...
    private func drawPoint() {
        ...
        path.addArc(withCenter: .init(x: width/2, y: width/2),
                    ...
                    endAngle: CGFloat((Double.pi * 0.3) - 0.1),
                    clockwise: false)
        point.lineCap     = CAShapeLayerLineCap.round
        point.lineWidth   = lineWidth*2
        point.fillColor   = UIColor.clear.cgColor
        point.strokeColor = UIColor.init(red: 145/255, green: 145/255, blue: 160/255, alpha: 1).cgColor
    ...
    private func addPointAnimation() {
        ...
        path.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeIn)
        path.duration = 2
        path.isRemovedOnCompletion = false
        path.fillMode = CAMediaTimingFillMode.backwards
