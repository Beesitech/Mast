...
open class DKPopoverViewController: UIViewController {
    ...
    private class DKPopoverView: UIView {
        ...
        func arrowImage() -> UIImage {
            ...
            context?.setFillColor((UserDefaults.standard.object(forKey: "theme") == nil || UserDefaults.standard.object(forKey: "theme") as! Int == 0) ? UIColor(red: 250/255.0, green: 250/255.0, blue: 250/255.0, alpha: 1.0).cgColor : (UserDefaults.standard.object(forKey: "theme") != nil && UserDefaults.standard.object(forKey: "theme") as! Int == 1) ? UIColor(red: 38/255.0, green: 38/255.0, blue: 48/255.0, alpha: 1.0).cgColor : UIColor(red: 0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0).cgColor)
    ...
    func showInView(_ view: UIView) {
        ...
        self.popoverView.transform = self.popoverView.transform.translatedBy(x: 0, y: 50)
        UIView.animate(withDuration: 0.6, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.96, options: .allowUserInteraction, animations: {
	...
	func calculatePopoverViewFrame() -> CGRect {
        ...
        if popoverWidth == UIView.noIntrinsicMetric {
			if UI_USER_INTERFACE_IDIOM() == .pad {
				...
				popoverWidth = self.view.bounds.width - 60
			}
		}
