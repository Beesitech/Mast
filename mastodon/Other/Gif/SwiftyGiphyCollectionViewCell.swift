...
class SwiftyGiphyCollectionViewCell: UICollectionViewCell {
    ...
    fileprivate func setup() {
        ...
        backgroundRoundedCornerView.backgroundColor = UIColor.white.withAlphaComponent(0.06)
        ...
        foregroundRoundedCornerView.backgroundColor = UIColor.white.withAlphaComponent(0.06)
